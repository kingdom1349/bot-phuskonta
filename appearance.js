...
Biiofc.sendMessage(from, {text:`\`\`\`JOIN GUYS 850 MEMBER MAU BERBAGI VPS AND ADMIN PANEL\`\`\`\n\nhttps://chat.whatsapp.com/EvwRjBk5J3c5aETCiasuLF`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
  if (antipromosi)
...
// Anti Link
        ...
        await Biiofc.sendMessage(m.chat,
			...
			Biiofc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
			Biiofc.sendMessage(from, {text:`\`\`\`JOIN GUYS 850 MEMBER MAU BERBAGI VPS AND ADMIN PANEL\`\`\`\n\n@${kice.split("@")[0]} https://chat.whatsapp.com/EvwRjBk5J3c5aETCiasuLF`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
            }            
        }
...
Biiofc.readMessages([m.key])
 ...
 switch (command) {
case "menu": case "zaa": case "anggun": case "nish": case "DE4YOU": case "kon": case "ni": case "nzm": {
...
*_I Am Botzz Private Made By DE4YOUHost🗿_*
...
┣ ${prefix}domain34 de4youoffc.dev
┣ ${prefix}domain35 de4youjembot-17.dev
┗━━━━━━━━━━━━━━━━━━━

*NOTE :*
*> JOIN SUBDO? PM OZZY OFFCIAL*
*wa.me/6287769611199*
...
https://chat.whatsapp.com/Jp4HRAQC6YNJpwZMMxEvnt
